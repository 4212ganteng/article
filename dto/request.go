...
type ArticleRequest struct {
	Title        string    `json:"title" form:"title" gorm:"type: varchar(200)" validate:"required,min=2"`
	Content      string    `json:"content" form:"content" gorm:"type: text" validate:"required,min=2"`
